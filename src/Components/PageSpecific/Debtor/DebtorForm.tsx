...
const DebtorForm: FunctionComponent<DebtorFormProps> = ({formSubmit, presetData}) => {
    ...
    var formFieldInfo: FormFieldInfo[] = [
        ...
        {type: "text", placeholder: "Address1", apiName: "address1", requirements: {required: true, maxLength: 15}},
        {type: "text", placeholder: "Address2", apiName: "address2", requirements: {required: true, maxLength: 15}},
        {type: "text", placeholder: "Address3", apiName: "address3", requirements: {required: true, maxLength: 15}},
